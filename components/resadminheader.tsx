...
export default function ResAdminHeader({toggleMenu}: Props){
    return(
        <div>
            <header className = "z-index fixed top-0 left-0 right-0 z-50 bg-[#1b1b1b]  text-white gap-10 relative flex items-center justify-center min-h-[80px] px-4">
                ...
                <h2 className = " text-white text-1xl  mr-25">BistroBliss Restaurant/Admin Dashboard</h2>
              
        <h3 className = "text-white text-1xl ml-100">Ali Hamdani</h3> 
